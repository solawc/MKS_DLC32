...
#else   
    print_src.print_Label_p_suspend = mks_lvgl_long_sroll_label_with_wight_set_center(mks_global.mks_src_1, print_src.print_Label_p_suspend, print_src1_first_pic_x+11, 70, "Run", 50);
