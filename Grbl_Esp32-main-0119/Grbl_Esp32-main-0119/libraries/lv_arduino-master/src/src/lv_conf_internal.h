...
/* Input device read period in milliseconds *//*输入设备读取周期(毫秒)*/
#ifndef LV_INDEV_DEF_READ_PERIOD
#define LV_INDEV_DEF_READ_PERIOD          10
#endif

/* Drag threshold in pixels *//*拖动阈值(以像素为单位)*/
#ifndef LV_INDEV_DEF_DRAG_LIMIT
#define LV_INDEV_DEF_DRAG_LIMIT           10
#endif

/* Drag throw slow-down in [%]. Greater value -> faster slow-down *//*拖动抛出速度减慢(以[%]为单位)。更大的价值->更快的降速*/
...
/*长压力机重复触发周期[ms]。
*`LV_EVENT_LONG_PRESSED_REPEAT之间的时间间隔*/
#ifndef LV_INDEV_DEF_LONG_PRESS_REP_TIME
#define LV_INDEV_DEF_LONG_PRESS_REP_TIME  100
#endif


/* Gesture threshold in pixels *//*手势阈值(像素)*/
#ifndef LV_INDEV_DEF_GESTURE_LIMIT
#define LV_INDEV_DEF_GESTURE_LIMIT        50
#endif

/* Gesture min velocity at release before swipe (pixels)*//*滑动前释放时的手势最小速度(像素)*/
