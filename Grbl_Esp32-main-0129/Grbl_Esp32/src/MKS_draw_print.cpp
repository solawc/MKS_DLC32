...
void mks_draw_print(void) {
    ...
    lv_imgbtn_creat_mks(scr, imgbtn_power_add, &mAdd , &mAdd, LV_ALIGN_CENTER, 100,-50, event_handle_mAdd);
	lv_imgbtn_creat_mks(scr, imgbtn_power_add, &mAdd, &mAdd, LV_ALIGN_CENTER, 100, 0, event_handle_mAdd);
	lv_imgbtn_creat_mks(scr, imgbtn_power_add, &mAdd, &mAdd, LV_ALIGN_CENTER, 100, 50, event_handle_mAdd);

	lv_imgbtn_creat_mks(scr, imgbtn_power_dec, &mDec, &mDec, LV_ALIGN_CENTER, 180, -50, event_handle_mDec);
	lv_imgbtn_creat_mks(scr, imgbtn_power_dec, &mDec, &mDec, LV_ALIGN_CENTER, 180, 0, event_handle_mDec);
	lv_imgbtn_creat_mks(scr, imgbtn_power_dec, &mDec, &mDec, LV_ALIGN_CENTER, 180, 50, event_handle_mDec);
